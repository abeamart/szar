...
module.exports = async (interaction, client, handler) => {
    ...
    if (interaction.customId === 'verkontynuuj') {
        await interaction.deferReply({ ephemeral: true }).then(async () => {
            ...
            if (verchan == false) {
                interaction.editReply({ ephemeral: true, content: "hm.. ten kanał został usunięty, kliknij na przycisk 'personalizuj' ponowanie!" })
        ...
        await interaction.deferReply({ ephemeral: true }).then(async () => {
            ...
            const verchan = await canfetch(interaction.guild.channels, verchanid)
            if (verchan == false) {
                interaction.editReply({ content: "hm.. ten kanał został usunięty, kliknij na przycisk 'personalizuj' ponowanie!" })
                console.log(error)
